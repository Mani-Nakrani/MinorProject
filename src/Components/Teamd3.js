...
const Teamd3 = () => {
  return (
    ...
    to="/Home" >
        ...
        <Container>
          <Box className="row" sx={{paddingBottom:15}}>
            ...
            <Box className="col-12 col-lg-8 col-md-6">
                <Box>
                    <Typography variant="h5" sx={{color:"#666666",fontWeight:550,mt:17,borderBottom:"3px solid #c33",width:100,fontSize:20}}>About Me</Typography>
                    ...
                    <Typography variant="h5" sx={{color:"#666666",fontWeight:550,mt:2,borderBottom:"3px solid #c33",width:140,fontSize:20}} >Working Time</Typography>
                ...
                <Box>
                    <Typography variant="h5" sx={{color:"#666666",fontWeight:550,mt:3,borderBottom:"3px solid #c33",width:170,fontSize:20}} >Work Experience</Typography>
          ...
          <Box sx={{height:250,width:345,backgroundColor:"white",boxShadow:"0px 4px 20px rgba(0,0,0,0.2)",mb:5}}>
                          ...
                          <Box sx={{fontSize:18,mt:2,ml:5}}>Gender: Male</Box>
                    </Box>
        </Container>
      </Box>
    </Box>
