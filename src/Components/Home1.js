                ...
                <Box className='row'>
                    <Box className='col-12 col-lg-6 col-md-12 col-sm-12'>
                        <Box>
                             ...
                             <Typography sx={{color:"gray",ml:3,mt:1}}>Delicious food is a perfect blend of rich flavors, fresh ingredients,<br/> and inviting aromas that make every bite enjoyable.</Typography>
